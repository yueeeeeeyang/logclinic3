...
use crate::config::{
    ModelProfile, model_test_authorization_header, model_test_chat_completions_url,
    model_test_http_error_body_snippet, validate_model_profile_fields,
};
...
pub(crate) struct AiChatSseParser {
...
impl AiChatSseParser {
    ...
    pub(crate) fn push_bytes(&mut self, bytes: &[u8]) -> Result<Vec<AiChatSseParsedEvent>, String> {
