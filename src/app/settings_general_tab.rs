...
impl SettingsWindowView {
    ...
    pub(super) fn render_theme_setting_row(
        &self,
    ...
    pub(super) fn render_theme_segment_option(
        &self,
    ...
    pub(super) fn render_log_font_size_setting(
        &self,
        log_viewer_font_size: f32,
        palette: AppThemePalette,
        context: &mut Context<Self>,
    ...
    pub(super) fn render_log_font_size_button(
        &self,
        label: &'static str,
        enabled: bool,
        delta: f32,
