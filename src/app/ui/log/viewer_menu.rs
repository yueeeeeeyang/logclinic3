...
impl MainView {
    ...
    pub(in crate::app) fn open_log_viewer_context_menu(
        &mut self,
        tab_id: usize,
        window_x: f32,
        window_y: f32,
    ...
    pub(in crate::app) fn render_log_viewer_context_menu(
        &self,
        context: &mut Context<Self>,
    ...
    pub(in crate::app) fn render_log_viewer_context_menu_item(
        &self,
        tab_id: usize,
    ...
    pub(in crate::app) fn handle_log_viewer_context_menu_action(
        &mut self,
        tab_id: usize,
        action: LogViewerContextMenuAction,
        context: &mut Context<Self>,
    ...
    pub(in crate::app) fn log_viewer_save_source_for_tab(
        &self,
        tab_id: usize,
    ...
    pub(in crate::app) fn log_viewer_save_source_for_tab_from_tabs(
        tabs: &[OpenLogTab],
        tab_id: usize,
    ) -> Option<LogFileSource> {
        tabs.iter()
