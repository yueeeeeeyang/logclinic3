...
use super::settings_window::ModelIconButtonRequest;
use super::*;
...
impl SettingsWindowView {
    ...
    /// 渲染模型配置列表。
    pub(super) fn render_model_profile_list(
        &self,
    ...
    /// 渲染单个模型配置列表项。
    pub(super) fn render_model_profile_list_item(
        &self,
    ...
    /// 渲染模型配置单行字段。
    pub(super) fn render_model_text_field(
        &self,
    ...
    /// 渲染 API Key 显示/隐藏按钮。
    pub(super) fn render_model_api_key_visibility_button(
        &self,
    ...
    pub(super) fn render_model_icon_button<F>(
        &self,
    ...
    /// 渲染模型测试状态。
    pub(super) fn render_model_test_status(
        &self,
