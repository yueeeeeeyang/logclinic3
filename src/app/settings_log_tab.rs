...
impl SettingsWindowView {
    ...
    pub(super) fn render_quick_search_keywords_setting(
        &self,
        quick_search_keywords_is_editing: bool,
        focus_handle: gpui::FocusHandle,
        palette: AppThemePalette,
    ...
    /// 渲染快搜关键字编辑/保存按钮。
    pub(super) fn render_quick_search_keywords_edit_button(
        &self,
        is_editing: bool,
        palette: AppThemePalette,
        context: &mut Context<Self>,
    ...
    pub(super) fn render_thread_analysis_filter_setting(
        &self,
        thread_analysis_filter_is_editing: bool,
        focus_handle: gpui::FocusHandle,
        palette: AppThemePalette,
    ...
    /// 渲染线程分析过滤编辑/保存按钮。
    pub(super) fn render_thread_analysis_filter_edit_button(
        &self,
        is_editing: bool,
        palette: AppThemePalette,
        context: &mut Context<Self>,
