...
pub(in crate::app) fn ai_chat_database_path() -> Option<PathBuf> {
...
pub(in crate::app) fn open_ai_chat_database(path: &Path) -> Result<Connection, String> {
...
pub(in crate::app) fn initialize_ai_chat_database(connection: &Connection) -> Result<(), String> {
...
pub(in crate::app) fn load_ai_chat_conversations(
    path: &Path,
) -> Result<Vec<AiChatConversation>, String> {
...
pub(in crate::app) fn load_ai_chat_messages(
    path: &Path,
    conversation_id: &str,
...
/// 插入 AI 对话会话。
pub(in crate::app) fn insert_ai_chat_conversation(
    path: &Path,
...
pub(in crate::app) fn update_ai_chat_conversation(
    path: &Path,
    conversation: &AiChatConversation,
) -> Result<(), String> {
    let connection = open_ai_chat_database(path)?;
...
/// 删除 AI 对话会话。
pub(in crate::app) fn delete_ai_chat_conversation(
    path: &Path,
    conversation_id: &str,
) -> Result<(), String> {
    let connection = open_ai_chat_database(path)?;
...
/// 插入 AI 对话消息。
pub(in crate::app) fn insert_ai_chat_message(
    path: &Path,
...
/// 更新 AI 对话消息内容和状态。
pub(in crate::app) fn update_ai_chat_message(
    path: &Path,
    message: &AiChatMessage,
) -> Result<(), String> {
    let connection = open_ai_chat_database(path)?;
